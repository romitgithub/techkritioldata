(function() {
	...
	var allImages = {
		page1 : ['<a href="#" data-largesrc="img/speaker1bg.jpg"><img src="img/speakers/1.jpg" alt="img01"/></a>','<a href="#"><img src="img/speakers/2.jpg" alt="img02"/></a>','<a href="#"><img src="img/speakers/3.jpg" alt="img03"/></a>'],
		page2 : ['<a href="#"><img src="img/speakers/4.jpg" alt="img04"/></a>','<a href="#"><img src="img/speakers/5.jpg" alt="img05"/></a>','<a href="#"><img src="img/speakers/6.jpg" alt="img06"/></a>'],
		page3 : ['<a href="#"><img src="img/speakers/7.jpg" alt="img17"/></a>','<a href="#"><img src="img/speakers/8.jpg" alt="img18"/></a>','<a href="#"><img src="img/speakers/9.jpg" alt="img19"/></a>'],
		page4 : ['<a href="#"><img src="img/speakers/10.jpg" alt="img20"/></a>','<a href="#"><img src="img/speakers/11.jpg" alt="img21"/></a>']
	};
	...
	function init() {
		[].forEach.call( document.querySelectorAll( '.main' ), function( el ) {
			...
			var grid = el.querySelector( '.og-grid' ),
